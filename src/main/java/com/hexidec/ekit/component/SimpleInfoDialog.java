...
public class SimpleInfoDialog extends JDialog
{
	...
	public SimpleInfoDialog(Window parent, String title, boolean bModal, String message, int type) {
		super(parent, title);
		...
		this.pack();
		this.setLocation(SwingUtilities.getPointForCentering(this, parent));
		this.setVisible(true);
	}

	public SimpleInfoDialog(Window parent, String title, boolean bModal, String message)	{
		this(parent, title, bModal, message, WARNING);
	}

	public SimpleInfoDialog(Window parent, String title, String message)	{
		this(parent, title, true, message, WARNING);
	}
