...
{
	private static final Log log = LogFactory.getLog(UnicodeDialog.class);
...
*/
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		else
		{
			...
			catch(java.io.IOException ioe) { log.error("IOException during character insertion", ioe); }
			catch(javax.swing.text.BadLocationException ble) { log.error("BadLocationException during character insertion", ble); }
		}
	}
