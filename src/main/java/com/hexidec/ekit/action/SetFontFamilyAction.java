...
public class SetFontFamilyAction extends StyledEditorKit.FontFamilyAction
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			FontSelectorDialog fsdInput = new FontSelectorDialog(parentEkit.getWindow(), Translatrix.getTranslationString("FontDialogTitle"), true, "face", parentEkit.getTextPane().getSelectedText());
