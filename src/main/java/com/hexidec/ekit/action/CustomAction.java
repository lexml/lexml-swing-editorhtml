...
public class CustomAction extends StyledEditorKit.StyledTextAction
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(this.isEnabled())
		{
			...
			{
				SimpleInfoDialog sidWarn = new SimpleInfoDialog(parentEkit.getWindow(), Translatrix.getTranslationString("Error"), true, Translatrix.getTranslationString("ErrorNoTextSelected"), SimpleInfoDialog.ERROR);
			}
			else
			{
				...
				else if(htmlTag.toString().equals(HTML.Tag.FONT.toString()))
				{
					...
					{
						Color color = new JColorChooser().showDialog(parentEkit.getWindow(), Translatrix.getTranslationString("CustomColorDialog"), Color.black);
					    if(color != null)
						{
