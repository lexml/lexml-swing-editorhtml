...
public class DocumentRenderer implements Printable
{
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) {
        ...
        Rectangle allocation =
            new Rectangle(0, (int) -pageStartY, (int) (jeditorPane.getMinimumSize().getWidth()),
    ...
    public void printHtmlString(String html, Dimension dim) {
        ...
        jeditorPane.setEditorKit(htmk);
        jeditorPane.setDocument(htdoc);
    ...
    public void setSize(Dimension dim) {
        jeditorPane.setMinimumSize(new Dimension(dim));
    }
}
